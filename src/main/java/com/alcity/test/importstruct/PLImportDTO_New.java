package com.alcity.test.importstruct;
...
public class PLImportDTO_New implements Serializable {
    ...
    private Collection<PLRuleImport_New> rules;
    ...
    public Collection<PLRuleImport_New> getRules() {
        return rules;
    }

    public void setRules(Collection<PLRuleImport_New> rules) {
        this.rules = rules;
    }
    ...
    public PLImportDTO_New() {
    }

    public PLImportDTO_New(Long puzzleGroupId, Long puzzleTemplateId, Long id, String code, String title, Long ordering, Integer fromAge, Integer toAge,
