    ...
    public void run(String... args) throws Exception {
      ...
      //  BinaryContent puzzle_ground_binary_content_1 = new BinaryContent(1L, now, now,admin_1 , admin_1,"puzzle ground for hash image",puzzle_Ground_Image_1.length,puzzle_Ground_Image_1,null,"tag1","","",BinaryContentType.Image);
       ...
       // PuzzleCategory mathematic = puzzleCategoryService.findByValue("mathematic");
        ...
        AttributeValue  instance_img5_targetX_value= new AttributeValue(null,2,null,null,null,null,null,null,Boolean.FALSE,null,ImageObject01_variable_1,1L,now,now,admin_1,admin_1,instance_img5.getId(),AttributeOwnerType.Instance_Puzzle_Group_Object_Variable);
...
//        attributeValueService.save(rulePostAction_18_move_param_2_value);
        ...
        PLRulePostAction move_rule_post_Action_19 = new PLRulePostAction(rule_for_move,FireEventAction_check.get(),18,"","",
                "",new StringBuffer(""),"","",1L ,now,now,admin_1,admin_1);
