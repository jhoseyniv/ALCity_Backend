   ...
   @Autowired
    ...
    public void run(String... args) throws Exception {
       ...
       Integer stars = ToolBox.getPuzzleLevelStars(playScore,puzzleLevel.getFirstStarScore(),puzzleLevel.getSecondStarScore(),puzzleLevel.getThirdStartScore());
        ...
        AttributeValue  obj_1_1_property_1_value= new AttributeValue(null,null,null,"text in obj_1_1",null,null,null,null,Boolean.FALSE,null,obj_1_1_property_1,1L,now,now,admin_1,admin_1,obj_1_1.getId(),AttributeOwnerType.Instance_Puzzle_Group_Object_Property);
        ...
        AttributeValue  obj_1_2_property_1_value= new AttributeValue(null,null,null,"",null,null,null,null,Boolean.FALSE,null,obj_1_2_property_1,1L,now,now,admin_1,admin_1,obj_1_2.getId(),AttributeOwnerType.Instance_Puzzle_Group_Object_Property);
        ...
        AttributeValue  obj_1_3_property_1_value= new AttributeValue(null,null,null,"",null,null,null,null,Boolean.FALSE,null,obj_1_3_property_1,1L,now,now,admin_1,admin_1,obj_1_3.getId(),AttributeOwnerType.Instance_Puzzle_Group_Object_Property);
        ...
        AttributeValue  obj_2_1_property_1_value= new AttributeValue(null,null,null,"",null,null,null,null,Boolean.FALSE,null,obj_2_1_property_1,1L,now,now,admin_1,admin_1,obj_2_1.getId(),AttributeOwnerType.Instance_Puzzle_Group_Object_Property);
        ...
        AttributeValue  obj_2_2_property_1_value= new AttributeValue(null,null,null,"",null,null,null,null,Boolean.FALSE,null,obj_2_2_property_1,1L,now,now,admin_1,admin_1,obj_2_2.getId(),AttributeOwnerType.Instance_Puzzle_Group_Object_Property);
        ...
        AttributeValue  obj_2_3_property_1_value= new AttributeValue(null,null,null,"",null,null,null,null,Boolean.FALSE,null,obj_2_3_property_1,1L,now,now,admin_1,admin_1,obj_2_3.getId(),AttributeOwnerType.Instance_Puzzle_Group_Object_Property);
        ...
        AttributeValue  obj_3_1_property_1_value= new AttributeValue(null,null,null,"",null,null,null,null,Boolean.FALSE,null,obj_3_1_property_1,1L,now,now,admin_1,admin_1,obj_3_1.getId(),AttributeOwnerType.Instance_Puzzle_Group_Object_Property);
        ...
        AttributeValue  obj_3_2_property_1_value= new AttributeValue(null,null,null,"",null,null,null,null,Boolean.FALSE,null,obj_3_2_property_1,1L,now,now,admin_1,admin_1,obj_3_2.getId(),AttributeOwnerType.Instance_Puzzle_Group_Object_Property);
        ...
        AttributeValue  obj_3_3_property_1_value= new AttributeValue(null,null,null,"",null,null,null,null,Boolean.FALSE,null,obj_3_3_property_1,1L,now,now,admin_1,admin_1,obj_3_3.getId(),AttributeOwnerType.Instance_Puzzle_Group_Object_Property);
