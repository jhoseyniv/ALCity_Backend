...
/*
        ...
        PLGround pl_Memory_Game_ground = new PLGround(4,5,xPos,yPos,zPos,xRotation,yRotation,zRotation,zoom,pan,rotation,pipe_Game, boardGraphic2,1L,now,now,admin_1,admin_1);
        ...
        AttributeValue  ImageObject01_variable_ImageObject01_variable_canRotate_value= new AttributeValue(true,null,null,null,null,null,null,null,Boolean.FALSE,null,ImageObject01_variable_canRotate,1L,now,now,admin_1,admin_1,imageObject_in_pipegame.getId(),AttributeOwnerType.Puzzle_Group_Object_Variable);
        ...
        BinaryContent instance_img_1_1_bytes_content = new BinaryContent(1L, now, now,admin_1 , admin_1,"instance_img1_1",instance_img_1_1_bytes.length,instance_img_1_1_bytes,null,"instance_img1_1","","",BinaryContentType.Image);
        ...
        AttributeValue instance_img_1_1_canRotate_value1 = new AttributeValue(false,null,null,null,null,null,null,null,false,null,ImageObject01_variable_canRotate,1L,now,now,admin_1,admin_1,instance_img_1_1.getId(),AttributeOwnerType.Instance_Puzzle_Group_Object_Variable);
        attributeValueService.save(instance_img_1_1_canRotate_value1);
        ...
        AttributeValue instance_img_1_3_canRotate_value1 = new AttributeValue(false,null,null,null,null,null,null,null,false,null,ImageObject01_variable_canRotate,1L,now,now,admin_1,admin_1,instance_img_1_3.getId(),AttributeOwnerType.Instance_Puzzle_Group_Object_Variable);
        attributeValueService.save(instance_img_1_3_canRotate_value1);
        ...
        attributeValueService.save(instance_img_1_5_canRotate_value1);
        ...
        AttributeValue instance_img_2_1_canRotate_value1 = new AttributeValue(false,null,null,null,null,null,null,null,false,null,ImageObject01_variable_canRotate,1L,now,now,admin_1,admin_1,instance_img_2_1.getId(),AttributeOwnerType.Instance_Puzzle_Group_Object_Variable);
        attributeValueService.save(instance_img_2_1_canRotate_value1);
        ...
        AttributeValue  instance_img_2_2_bgImage_value= new AttributeValue(null,null,null,null,null,null,instance_img_2_2_bytes_content.getId(),null,Boolean.FALSE,null,ImageObject01_property_bgImage,1L,now,now,admin_1,admin_1,instance_img_2_2.getId(),AttributeOwnerType.Instance_Puzzle_Group_Object_Property);
        attributeValueService.save(instance_img_2_2_bgImage_value);
        ...
        AttributeValue  instance_img_2_3_bgImage_value= new AttributeValue(null,null,null,null,null,null,instance_img_2_3_bytes_content.getId(),null,Boolean.FALSE,null,ImageObject01_property_bgImage,1L,now,now,admin_1,admin_1,instance_img_2_3.getId(),AttributeOwnerType.Instance_Puzzle_Group_Object_Property);
        attributeValueService.save(instance_img_2_3_bgImage_value);
        ...
        AttributeValue  instance_img_2_4_bgImage_value= new AttributeValue(null,null,null,null,null,null,instance_img_2_4_bytes_content.getId(),null,Boolean.FALSE,null,ImageObject01_property_bgImage,1L,now,now,admin_1,admin_1,instance_img_2_4.getId(),AttributeOwnerType.Instance_Puzzle_Group_Object_Property);
        attributeValueService.save(instance_img_2_4_bgImage_value);
        ...
        AttributeValue  instance_img_2_5_bgImage_value= new AttributeValue(null,null,null,null,null,null,instance_img_2_5_bytes_content.getId(),null,Boolean.FALSE,null,ImageObject01_property_bgImage,1L,now,now,admin_1,admin_1,instance_img_2_5.getId(),AttributeOwnerType.Instance_Puzzle_Group_Object_Property);
        attributeValueService.save(instance_img_2_5_bgImage_value);
        ...
        AttributeValue instance_img_3_1_canRotate_value1 = new AttributeValue(false,null,null,null,null,null,null,null,false,null,ImageObject01_variable_canRotate,1L,now,now,admin_1,admin_1,instance_img_3_1.getId(),AttributeOwnerType.Instance_Puzzle_Group_Object_Variable);
        attributeValueService.save(instance_img_3_1_canRotate_value1);
        ...
        AttributeValue instance_img_3_3_possibleDirs_value1 = new AttributeValue(null,4,null,null,null,null,null,null,false,null,ImageObject01_variable_possibleDirs,1L,now,now,admin_1,admin_1,instance_img_3_3.getId(),AttributeOwnerType.Instance_Puzzle_Group_Object_Variable);
        attributeValueService.save(instance_img_3_3_possibleDirs_value1);
        ...
        AttributeValue instance_img_3_4_canRotate_value1 = new AttributeValue(false,null,null,null,null,null,null,null,false,null,ImageObject01_variable_canRotate,1L,now,now,admin_1,admin_1,instance_img_3_4.getId(),AttributeOwnerType.Instance_Puzzle_Group_Object_Variable);
        ...
        AttributeValue instance_img_3_5_possibleDirs_value1 = new AttributeValue(null,2,null,null,null,null,null,null,false,null,ImageObject01_variable_possibleDirs,1L,now,now,admin_1,admin_1,instance_img_3_5.getId(),AttributeOwnerType.Instance_Puzzle_Group_Object_Variable);
        ...
        AttributeValue instance_img_4_1_canRotate_value1 = new AttributeValue(false,null,null,null,null,null,null,null,false,null,ImageObject01_variable_canRotate,1L,now,now,admin_1,admin_1,instance_img_4_1.getId(),AttributeOwnerType.Instance_Puzzle_Group_Object_Variable);
        attributeValueService.save(instance_img_4_1_canRotate_value1);
        ...
        AttributeValue instance_img_4_2_canRotate_value1 = new AttributeValue(false,null,null,null,null,null,null,null,false,null,ImageObject01_variable_canRotate,1L,now,now,admin_1,admin_1,instance_img_4_2.getId(),AttributeOwnerType.Instance_Puzzle_Group_Object_Variable);
        ...
        AttributeValue instance_img_4_3_canRotate_value1 = new AttributeValue(false,null,null,null,null,null,null,null,false,null,ImageObject01_variable_canRotate,1L,now,now,admin_1,admin_1,instance_img_4_3.getId(),AttributeOwnerType.Instance_Puzzle_Group_Object_Variable);
        attributeValueService.save(instance_img_4_3_canRotate_value1);
        ...
        AttributeValue instance_img_4_4_canRotate_value1 = new AttributeValue(false,null,null,null,null,null,null,null,false,null,ImageObject01_variable_canRotate,1L,now,now,admin_1,admin_1,instance_img_4_4.getId(),AttributeOwnerType.Instance_Puzzle_Group_Object_Variable);
        attributeValueService.save(instance_img_4_4_canRotate_value1);
        ...
        AttributeValue instance_img_4_5_canRotate_value1 = new AttributeValue(false,null,null,null,null,null,null,null,false,null,ImageObject01_variable_canRotate,1L,now,now,admin_1,admin_1,instance_img_4_5.getId(),AttributeOwnerType.Instance_Puzzle_Group_Object_Variable);
        attributeValueService.save(instance_img_4_5_canRotate_value1);
        ...
        PLRulePostAction VariableAssignmentAction_2 = new PLRulePostAction(rule_for_Click.getId(),PLRulePostActionOwnerType.Puzzle_Level_Rule,PLRulePostActionType.VariableAssignmentAction,2,"","",
        ...
        PLRulePostAction VariableAssignmentAction_3 = new PLRulePostAction(rule_for_Click.getId(),PLRulePostActionOwnerType.Puzzle_Level_Rule,PLRulePostActionType.VariableAssignmentAction,3,"","",
        ...
        PLRulePostAction VariableAssignmentAction_4 = new PLRulePostAction(rule_for_Click.getId(),PLRulePostActionOwnerType.Puzzle_Level_Rule,PLRulePostActionType.VariableAssignmentAction,4,"","",
                "BoardVar(solved)",new StringBuffer("BoardVar(solved)+cond(equal(InstVar(InstByPos(EventParam(row), EventParam(col)), currentDir),InstVar(InstByPos(EventParam(row), EventParam(col)), correctDir)),1,0)"),"","","",0L,1L ,now,now,admin_1,admin_1);
        plRulePostActionService.save(VariableAssignmentAction_4);

        PLRulePostAction CallObjectAction_4_Click = new PLRulePostAction(rule_for_Click.getId(),PLRulePostActionOwnerType.Puzzle_Level_Rule,PLRulePostActionType.CallObjectAction,5,"Rotate","InstProp(InstByPos(EventParam(row),EventParam(col)),objectId)",
                "",new StringBuffer(""),"","","",0L,1L ,now,now,admin_1,admin_1);
        plRulePostActionService.save(CallObjectAction_4_Click);

        PLRulePostAction FireEventAction_5_Click = new PLRulePostAction(rule_for_Click.getId(),PLRulePostActionOwnerType.Puzzle_Level_Rule,PLRulePostActionType.FireEventAction,6,"","",
                "",new StringBuffer(""),"","","",0L,1L ,now,now,admin_1,admin_1);
