...
//  }
    ...
    public RedisCacheManager cacheManager() {
        ...
        return RedisCacheManager.builder(redisConnectionFactory())
                ...
                .withCacheConfiguration("getFileThumbnail", myDefaultCacheConfig(Duration.ofMinutes(30)))
                .withCacheConfiguration("getFileContent", myDefaultCacheConfig(Duration.ofMinutes(30)))
                .withCacheConfiguration("getPublicPuzzleLevels", myDefaultCacheConfig(Duration.ofMinutes(30)))
                .withCacheConfiguration("getRadarChart", myDefaultCacheConfig(Duration.ofMinutes(30)))
                .withCacheConfiguration("all-LearningSkillDTO", myDefaultCacheConfig(Duration.ofMinutes(30)))
                ...
                .withCacheConfiguration("findVariablesForPuzzleGroupObject", myDefaultCacheConfig(Duration.ofMinutes(50)))
                .withCacheConfiguration("defined_prop;'erties_in_instance", myDefaultCacheConfig(Duration.ofMinutes(50)))
