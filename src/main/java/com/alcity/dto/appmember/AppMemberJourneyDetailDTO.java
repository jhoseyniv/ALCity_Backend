...
public class AppMemberJourneyDetailDTO {
    private Long id;
    ...
    public AppMemberJourneyDetailDTO() {
    }

    public AppMemberJourneyDetailDTO(Long id, String title, Long passedImageId, Long currentImageId, Long lockedImageId,
